...
{
    x_min = $('content_div_1').offsetLeft;
    x_max = $('content_div_2').offsetLeft + $('content_div_2').offsetWidth - $('black_bar_separator_div').offsetWidth;
    y_snap = $('content_div_2').offsetTop;
    return [ (x < x_max-50) ? (x > x_min+50 ? x : x_min ) : x_max, y_snap];
}

function end_drag()
{
    frac_left_black_bar = $('black_bar_separator_div').offsetLeft;
    left_1_pos = content_div_1.offsetLeft;
    black_bar_width= black_bar_separator_div.offsetWidth;
    bar_position_scale = (frac_left_black_bar - left_1_pos )/(window.innerWidth - left_1_pos - black_bar_width);
...
function load_pages()
{
    ...
    location_page_views.each(function(page_view)
    {
...
group_page_views.push(new PageView("groups", "Group", "Remove users",false,
    ...
    group_person_page_views.each(function(page_view)
    {
    ...
    group_institution_page_views.each(function(page_view)
    {
    ...
    group_course_page_views.each(function(page_view)
    {
    ...
    group_lecture_page_views.each(function(page_view)
    {
    ...
    group_attendee_page_views.each(function(page_view)
    {
    ...
    group_location_page_views.each(function(page_view)
    {
    ...
    group_tutorial_page_views.each(function(page_view)
    {
    ...
    group_tutorial_schedule_page_views.each(function(page_view)
    {
    ...
    group_agatha_email_page_views.each(function(page_view)
    {
    ...
    group_email_template_page_views.each(function(page_view)
    {
    ...
    group_willing_lecturer_page_views.each(function(page_view)
    {
    ...
    group_willing_tutor_page_views.each(function(page_view)
    {
    ...
    group_user_page_views.each(function(page_view)
    {
 ...
 agatha_email_page_views.push(new PageView("agatha_emails", "AgathaEmail", "Send agatha_emails",true,
  ...
  agatha_file_page_views.push(new PageView("agatha_files", "AgathaFile", "Delete agatha_files",true,
   ...
   agatha_file_page_views.each(function(page_view)
    {
  ...
  emal_attachment_page_views.push(new PageView("email_attachments", "EmailAttachment", "Delete email_attachments",true,
   ...
   emal_attachment_page_views.each(function(page_view)
    {
...
//    bar_position_scale = 0.3;
    ...
    frac_left_black_bar = (window.innerWidth - left_1_pos - black_bar_width)*bar_position_scale + left_1_pos;
