...
#    RAILS_DEFAULT_LOGGER.error( "new AttributeList" );
    ...
    for attribute in attributes
       ...
       if(ind == nil)
           attribute_element = AttributeElement.new(attribute.name, attribute.type, table_name_, "","", attribute.primary);
       else
           attribute_element = AttributeElement.new(attribute.name, attribute.type, table_name_, reflections[ind].name.to_s,  reflections[ind].class_name,attribute.primary);
       end
